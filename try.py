...
# ----------------- USER CONFIG -----------------
# IDENTICAL PATHS & HYPERPARAMS TO YOUR QE CODE
PRETRAINED_CHECKPOINT = "/home/user2/githubstruct/models/ECAPA/voxceleb.pt" 
DATASET_ROOT = "/home/user2/VOIP/VOIP_Mel_Features"
FINETUNE_CHECKPOINT_DIR = "/home/user2/VOIP/finetune_checkpoints_ecapa_voip"
LOG_DIR = "/home/user2/VOIP/finetune_logs_ecapa_voip"
...
# --- FIX 1: Increased Learning Rate for Adaptation ---
LR_MODEL = 1e-4  # Increased from 1e-5 to help adapt to VoIP domain
LR_HEAD = 1e-4
WEIGHT_DECAY = 2e-5

# --- FIX 2: Increased Margin ---
# AAM params
AAM_MARGIN = 0.2  # Increased from 0.0 to force cluster separation
AAM_SCALE = 30.0
...
if FREEZE_EPOCHS > 0:
    ...
    # --- FIX 4: Do NOT freeze BN initially if no freeze epochs
    # We want BN to update immediately for VoIP domain
    pass 

# ----------------- Training loop -----------------
def train_one_epoch(epoch):
    model.train()
    # --- FIX 4: CRITICAL REMOVAL ---
    # freeze_bn_stats(model) <--- Removed to allow BN to adapt to VoIP data
...
# ----------------- Main Training -----------------
logging.info("=== Starting fine-tuning of Standard ECAPA-TDNN ===")
